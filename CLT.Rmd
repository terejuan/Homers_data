...
In conclusion as we worked trough the data we notice that the sample size changed as we divide by the square root of our sample size. this showed us how the central limitation is put to work, the mean stays the same but the standard deviation will change numbers as we continue to divide.
